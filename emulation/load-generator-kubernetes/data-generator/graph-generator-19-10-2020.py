...
# Query InfluxDB
monitoring_data = influxdb.query("select conferences, participants, host from jitsi_stats where time >= '2020-11-18T15:00:00Z' AND time < '2020-11-19T15:00:00Z';")
...
plt.title('Total Conferences (19/10/2020)')
ax.xaxis.set_major_formatter(xformatter)

ax = plt.subplot(312)
plt.plot(participants[0], participants[1])
plt.title('Total Participants (19/10/2020)')
ax.xaxis.set_major_formatter(xformatter)

ax = plt.subplot(313)
plt.plot(avg_part_per_conf[0], avg_part_per_conf[1])
plt.title('Average Participants per Conference (19/10/2020)')
ax.xaxis.set_major_formatter(xformatter)
